...
package fr.redmoon.tictac.gui.numberpicker;
...
public class NumberPicker extends LinearLayout implements OnClickListener,
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mIncrementButton = (NumberPickerButton) findViewById(R.id.num_increment);
        mIncrementButton.setOnClickListener(this);
        mIncrementButton.setOnLongClickListener(this);
        mIncrementButton.setNumberPicker(this);
        mDecrementButton = (NumberPickerButton) findViewById(R.id.num_decrement);
        mDecrementButton.setOnClickListener(this);
        mDecrementButton.setOnLongClickListener(this);
        mDecrementButton.setNumberPicker(this);

        mText = (EditText) findViewById(R.id.num_input);
    ...
    public void onClick(View v) {
        ...
        if (R.id.num_increment == v.getId()) {
            changeCurrent(mCurrent + 1);
        } else if (R.id.num_decrement == v.getId()) {
            changeCurrent(mCurrent - 1);
        }
    }
