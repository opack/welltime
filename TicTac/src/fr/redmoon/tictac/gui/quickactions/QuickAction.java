...
public class QuickAction extends PopupWindows implements OnDismissListener {
	...
	private SparseArray<View> mActionViews = new SparseArray<View>();
	...
	public void addActionItem(ActionItem action) {
		...
		View container	= (View) inflater.inflate(R.layout.itm_quickaction, null);
		...
		mActionViews.put(actionId, container);
	...
	public void setActionVisible(final int actionId, final boolean visible) {
		final View view = mActionViews.get(actionId);
		if (view != null) {
